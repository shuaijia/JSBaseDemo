...
public class LifeMethodTwoActivity extends Activity {
    ...
    private TextView tv_lifecycle_b2;
...
//        Log.e(TAG, "onCreate: B");
        ...
        tv_lifecycle_b2= (TextView) findViewById(R.id.tv_lifecycle_b2);
        tv_lifecycle_b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LifeMethodTwoActivity.this,LifeMehodThreeActivity.class));
            }
        });
    }
