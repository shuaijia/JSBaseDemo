package com.jia.demo.view.behavior;
...
/**
 * Describtion:下拉越界回弹效果behavior
 * Created by jia on 2017/7/3.
 * 人之所以能，是相信能
 */
public class JsBehavior extends AppBarLayout.Behavior {
    ...
    private static final float TARGET_HEIGHT = 100; // 最大滑动距离
    ...
    public JsBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void recovery(final AppBarLayout abl) {
        if (mTotalDy > 0) {
            mTotalDy = 0;
            if (isAnimate) {
                ValueAnimator anim = ValueAnimator.ofFloat(mLastScale, 1f).setDuration(1500);
