 ...
 * 人之所以能，是相信能
 */
public class JsPasswordInputView extends EditText {
    ...
    public JsPasswordInputView(Context context) {
        super(context);
    }

    public JsPasswordInputView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.JsPasswordInputView, 0, 0);
        borderColor = a.getColor(R.styleable.JsPasswordInputView_jsBorderColor, borderColor);
        borderWidth = a.getDimension(R.styleable.JsPasswordInputView_jsBorderWidth, borderWidth);
        borderRadius = a.getDimension(R.styleable.JsPasswordInputView_jsBorderRadius, borderRadius);
        passwordLength = a.getInt(R.styleable.JsPasswordInputView_jsPasswordLength, passwordLength);
        passwordColor = a.getColor(R.styleable.JsPasswordInputView_jsPasswordColor, passwordColor);
        passwordWidth = a.getDimension(R.styleable.JsPasswordInputView_jsPasswordWidth, passwordWidth);
        passwordRadius = a.getDimension(R.styleable.JsPasswordInputView_jsPasswordRadius, passwordRadius);
        a.recycle();
    ...
    public JsPasswordInputView(Context context, AttributeSet attrs, int defStyleAttr) {
