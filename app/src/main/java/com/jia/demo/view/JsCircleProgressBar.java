...
/**
 * Describtion: 圆形进度条
 * Created by jia on 2017/5/11.
 * 人之所以能，是相信能
 */
public class JsCircleProgressBar extends View {

    private static final String TAG = "JsCircleProgressBar";
    ...
    public JsCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
