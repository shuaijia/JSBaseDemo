package com.jia.demo.view.miloading;
...
/**
 * Describtion:仿小米视频  加载中
 * Created by jia on 2017/9/6.
 * 人之所以能，是相信能
 */
public class MILoadingView extends View {
    //控件中心点坐标
    private int cvX,cvY;
    //三角形边长
    ...
    public MILoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
